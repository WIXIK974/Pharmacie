...
public class MenuView {
    ...
    public void commandesview(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/pharmacix/BoutonAccueil/Commandes.fxml"));
        if (loader.getLocation() == null) {
            System.err.println("File not found: /org/example/pharmacix/Commandes.fxml");
            return;
        }
        Parent root = loader.load();
